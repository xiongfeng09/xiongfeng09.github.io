---
layout: post
title: 实现SSH Public/Private Key的在多台电脑中的共用
category: util
tags: util
...
1. id_rsa和id_rsa.pub到云端/U盘/邮箱/…中备份。这两个文件位于用户目录下的隐藏文件夹~/.ssh/中。
2. 在NEW的终端(Terminal)上执行
ssh-keygen –t rsa –C "xiongfeng165@gmail.com"
...
```
chmod 644 id_ras.pub
```
/Users/xiongfeng/git/xiongfeng165.github.io/_posts/util/2015-03-05-word.md
